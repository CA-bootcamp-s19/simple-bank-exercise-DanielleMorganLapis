...
contract SimpleBank {
    ...
    function enroll() public returns (bool){
        require(enrolled[msg.sender] == false, "You're already enrolled!");
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
        /* If the sender's balance is at least the amount they want to withdraw,
           ...
           require(enrolled[msg.sender] == true, "Must be enrolled to withdraw");
           require(balances[msg.sender] >= withdrawAmount, "You don't have enough to withdraw that much!");
